...
public class BubbledLink extends Hyperlink {
    ...
    public BubbledLink(String arg0, Node arg1) {
        super(arg0, arg1);
        init();
    }

    public BubbledLink(String arg0) {
        super(arg0);
        init();
    }

    public BubbledLink(BubbleSpec bubbleSpec) {
        super();
        this.bs = bubbleSpec;
        init();
    }

    public BubbledLink(String arg0, Node arg1,BubbleSpec bubbleSpec) {
        super(arg0, arg1);
        this.bs = bubbleSpec;
        init();
    }

    public BubbledLink(String arg0,BubbleSpec bubbleSpec) {
        super(arg0);
        this.bs = bubbleSpec;
        init();
    }
